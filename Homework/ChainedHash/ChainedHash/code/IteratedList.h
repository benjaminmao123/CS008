...
public:
	...
	public:
		...
		LinkedListLibrary::node<ITEM_TYPE>* getNode() { return _ptr; }
		const LinkedListLibrary::node<ITEM_TYPE>* getNode() const { return _ptr; }
...
private:
	...
	LinkedListLibrary::node<ITEM_TYPE>* _tail_ptr;
};
...
inline List<ITEM_TYPE>::List()
	: _head_ptr(nullptr), _tail_ptr(nullptr)
{
}
...
inline List<ITEM_TYPE>::List(const List<ITEM_TYPE>& copyThis)
	...
	_tail_ptr(LinkedListLibrary::LastNode(copyThis._head_ptr))
{
}
...
{
	auto it = Iterator(LinkedListLibrary::InsertHead(_head_ptr, i));
...
inline typename List<ITEM_TYPE>::Iterator List<ITEM_TYPE>::InsertAfter(const ITEM_TYPE& i, Iterator iMarker)
{
	...
	auto it = Iterator(LinkedListLibrary::InsertAfter(_head_ptr, mNode, i));
	_tail_ptr = it.getNode();
...
inline typename List<ITEM_TYPE>::Iterator List<ITEM_TYPE>::InsertBefore(const ITEM_TYPE& i, Iterator iMarker)
{
	...
	auto it = Iterator(LinkedListLibrary::InsertBefore(_head_ptr, mNode, i));
...
{
	auto it = Iterator(LinkedListLibrary::InsertSorted(_head_ptr, i));
...
inline ITEM_TYPE List<ITEM_TYPE>::Delete(Iterator iMarker)
{
	...
	return LinkedListLibrary::DeleteNode(_head_ptr, mNode);
}
...
inline void List<ITEM_TYPE>::Swap(List& l)
{
	...
	std::swap(_tail_ptr, l._tail_ptr);
}
...
{
	LinkedListLibrary::PrintList(l._head_ptr);
